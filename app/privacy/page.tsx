...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "We process your name, address and e-mail to fulfil and ship your order and to comply with statutory retention duties (tax and commercial law). Legal basis: Art. 6(1)(b) and 6(1)(c) GDPR.",
  },
  {
    title: "Newsletter",
    body: "If you subscribe, your e-mail address is stored with our e-mail provider until you unsubscribe. Every mailing contains an unsubscribe link. Legal basis: consent (Art. 6(1)(a) GDPR).",
  },
  {
    title: "Your rights",
      ...
      <div className="mt-10 flex flex-col gap-9">
        {SECTIONS.map((s) => (
          <section key={s.title}>
            ...
            <p className="mt-3 text-[15px] leading-[1.75] text-[#333]">{s.body}</p>
          </section>
        ))}
      </div>
    </article>
